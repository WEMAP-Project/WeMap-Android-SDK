package asia.wemap.androidsdk.geometry;
 ...
 * </p>
 * <p>
 * WeMap GL displays maps in the Mercator Projection and projects geographical
...
public class LatLng implements Parcelable {
    ...
    public String getAPIPoint() {
        return String.valueOf(this.latitude) + "%2C" + String.valueOf(this.longitude);
    }
}
